...
## Connect to Server
In order to connect to your server, you'll need to login to our control panel nitro.evlbox.com

Grab your connection string. this can be found 
 - From the Dashboard, copy the IP address 
