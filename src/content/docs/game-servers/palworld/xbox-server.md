...
# How to Update Your Palworld Dedicated Server for Xbox
With the new 0.3.1 Sakurajima update for Palworld, dedicated servers have arrived for Xbox players. To make your server compatible with the Xbox version complete the following steps. 

:::caution
If you are switching your server between the Xbox and Steam Versions of the game you will have to create a separate character for each version. Your existing character data and inventories will not be linked.
:::
