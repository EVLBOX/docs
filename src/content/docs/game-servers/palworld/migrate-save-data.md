...
![palworldarchived.png](/docs/palworld/palworldarchived.png)
...
![unarchivesavedata.png](/docs/palworld/unarchivesavedata.png)
...
![server_breadcrumb.png](/docs/palworld/server_breadcrumb.png)

7. Now click on file manager and navigate to the Pal/Saved/Config/LinuxServer folder 

![linuxfolder_navigation.png](/docs/palworld/linuxfolder_navigation.png)

8. Scroll down and fild the "GameUserSettings.ini" file and click on it. 

![game_user_settings_file.png](/docs/palworld/game_user_settings_file.png)
...
![update_dedicated_server_name.png](/docs/palworld/update_dedicated_server_name.png)
