...
<HostingCTA game="project-zomboid" variant="switch" heading="Tired of fighting Workshop downloads?">
	On EVLBOX, Steam Workshop mods install from the Nitro panel and failed downloads
	retry automatically. Moving from another host? We'll migrate your existing world
	across for free — no downtime, no re-uploading saves.
</HostingCTA>
