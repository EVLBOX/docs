...
![mod_id_pika.png](/zomboid/mod_id_pika.png)
...
![server_data_mod_.png](/zomboid/server_data_mod_.png)

6. Scroll down to Line 182 and next to WorkshopItems= enter the Workship ID that you want to add .

![server_data_workshop.png](/zomboid/server_data_workshop.png)
...
![install_mods.png](/zomboid/install_mods.png)
...
![steam_collection2.png](/zomboid/steam_collection2.png)

2. Go to https://pzidgrabber.com/ and paste in the URL. Click Submit. 

![pzidgrab.png](/zomboid/pzidgrab.png)
...
![pzidgrab_list.png](/zomboid/pzidgrab_list.png)
