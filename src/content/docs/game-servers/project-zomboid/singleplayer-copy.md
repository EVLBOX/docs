...
![sftp_details.png](/docs/zomboid/sftp_details.png)
...
![fingerprint.png](/docs/zomboid/fingerprint.png)
![cyberduck_login.png](/docs/zomboid/cyberduck_login.png)

3. Navigate to the .cache folder. If it is not viewalbe, in the menu, click View, Show Hidden Files. 
![show_hidden_files.png](/docs/zomboid/show_hidden_files.png)

4. Then Navigate to .cache/Saves/Multiplayer

![multiplayer_saves.png](/docs/zomboid/multiplayer_saves.png)
...
![save_file_local_location.png](/docs/zomboid/save_file_local_location.png)
...
![upload_world.png](/docs/zomboid/upload_world.png)
...
![update_server_world.png](/docs/zomboid/update_server_world.png)
