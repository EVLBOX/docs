...
*Haven't claimed your server? [Start Here](/docs/game-servers/satisfactory/first-time-setup) first*

1. Open the Server Manager in the Satisfactory Game
2. Click your server, then choose "Manage Saves", then "Upload Save"

![upload](/docs/satisfactory/upload.jpg)
...
![nitro-upload](/docs/satisfactory/upload-saves.png)
