...
3. Upload your world folder. Full detail on both upload routes is in [Move a Singleplayer World to your Valheim Server](/docs/game-servers/valheim/import-singleplayer-world#4-upload-the-world) — the procedure is identical.
