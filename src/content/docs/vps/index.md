---
title: "Virtual Dedicated Server Guides"
description: "Our knoweldgebase entries on VPS and VDS management."
---
...
## VPS Information
 ...
 [**Reset the Root Password on a VPS**](/docs/vps/root-password-reset) - Find out how you can reset a lost root password on a VPS
 
  [**Setup SSH keys on your VPS's**](/docs/vps/ssh-keys) - Learn to add an SSH key to your Virtfusion account so that it is automatically added to all of your VPS automatically. 
 
 [**Taking Snapshot Backups**](/docs/vps/snapshot-backups) - Taking automatic snapshot backups of your VPS
 
 [**Secure your account with MFA**](/docs/vps/mfa-setup) - Setup MFA on your Virtufusion account
